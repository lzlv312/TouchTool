...
public class NumberLessAction extends NumberResultAction{

    public NumberLessAction() {
        super(ActionType.NUMBER_LESS);
    }

    public NumberLessAction(JsonObject jsonObject) {
        super(jsonObject);
    }
