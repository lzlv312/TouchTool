...
public class PinTopView extends PinView implements PinDragAble {
    ...
    public PinTopView(@NonNull Context context, ActionCard card, Pin pin, OnStartDragListener listener) {
